  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-around pb-16 py-16 w-full bg-pastelBlue px-6">
      ...
      <div className="text-center md:text-left mb-8 md:mb-0">
        <h2 className="text-3xl font-bold text-blavk-400">See Common Questions</h2>
        <h2 className="text-3xl font-bold text-black-400">and Answers</h2>
      </div>
      ...
      <div className="pt-4 md:pt-0 w-full md:w-2/3">
        <Accordion type="multiple">
          ...
          <AccordionItem value="item-2">
            <AccordionTrigger className="flex items-center justify-between text-start text-lg font-medium py-4 px-6 rounded-md shadow-md hover:bg-gray-100">
